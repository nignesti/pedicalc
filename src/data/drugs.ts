...
export const drugs: Drug[] = [
    ...
    indications: [
      {
        ...
        rule: {
          ...
          maxDose: 0.5,
          decimals: 2,
          notes: 'Dose minima 0.1 mg (evitare bradicardia paradossa). Ripetibile ogni 5 min, max 2 dosi. Max 1 mg adolescenti / adulti.',
        },
      },
    ],
  },
        ...
        routeVariants: [
          {
            ...
            rule: {
              ...
              maxDose: 100,
              decimals: 1,
              notes: 'Somministrare lentamente. Rischio di depressione respiratoria e rigidità toracica.',
            },
          },
          {
            id: 'in',
        ...
        routeVariants: [
          ...
          },
          {
            ...
            rule: {
              ...
              route: 'IN',
              decimals: 1,
              notes: 'Onset 5-10 min. Dividere la dose in metà per ciascuna narice.',
            },
          },
        ],
      },
...

  {
    ...
    indications: [
      ...
      {
        id: 'shock-settico',
        label: 'Shock Settico / Distributivo',
        rule: {
          kind: 'weight-range',
          factorMin: 10,
          factorMax: 20,
          ...
          route: 'EV/IO',
          decimals: 0,
          notes: 'Rivalutazione continua dei PV e ricerca di segni di accumulo.',
        },
      },
      {
        id: 'shock-cardiogeno',
